...
- Uma sessão bash persistente com estado por thread com semântica de PTY real — foreground, background, checagem de status, envio de texto, Enter/Ctrl-C/Ctrl-D, caracteres ASCII puros. Scripts multilinha e atalhos de comando funcionam; bytes NUL são rejeitados antes de alcançar o shell.
